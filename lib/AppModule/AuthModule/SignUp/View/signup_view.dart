...
import 'package:artxprochatapp/AppModule/AuthModule/SignUp/View/component/image_picker_bottom_sheet.dart';
...
import 'component/image_tile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: ListView(
          padding:
              EdgeInsets.symmetric(horizontal: SizeConfig.widthMultiplier * 20),
          children: [
            SizedBox(
