...
import '../VoiceChannelModule/Model/channel_name_model.dart';
...
class FirebaseGroupServices {
  ...
  Future<List<GroupsModel>> getGroupsList() async {
    ...
    groupsCollection
        ...
        .listen((data) {
      final groups =
          data.docs.map((e) => GroupsModel.fromJson(e.data())).toList();
